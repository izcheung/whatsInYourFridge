...
function search_recipes(){
    ...
    try {
        $.ajax({
            url: `https://api.spoonacular.com/recipes/findByIngredients?apiKey=35119e298b824e7481b7febdf3fabcaa&ingredients=${query_input_value}&ranking=1&number=3&ignorePantry=true`,
